...
Mysql::Mysql()
{
    ...
    m_pMysqlInfo->strUserName = "jabberd2";
    m_pMysqlInfo->strPassword = "123456";
    m_pMysqlInfo->strDBName = "jabberd2";
    m_pMysqlInfo->strCharacterSet = "UTF8";
    m_pMysqlInfo->iPort = MYSQL_PORT;
    */

    m_pMysqlInfo->strHostName = CConfiguration::GetMySQLHostname();
    m_pMysqlInfo->strUserName = CConfiguration::GetMySQLUsername();
    m_pMysqlInfo->strPassword = CConfiguration::GetMySQLPassword();
    m_pMysqlInfo->strDBName = CConfiguration::GetMySQLDataBase();
    m_pMysqlInfo->strCharacterSet = "UTF8";
    m_pMysqlInfo->iPort = CConfiguration::GetMySQLPort();
